      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            DAEMON-AI is structured into five comprehensive work packages, each focusing on 
            critical aspects of the project development and implementation.
          </p>
        </div>
              ...
              <Card key={deliverable.id} className="bg-gradient-card border-cyber-border">
                <CardContent className="p-6">
                  <div className="flex items-start justify-between mb-4">
                    ...
                    <Badge className={`${getStatusColor(deliverable.status)} text-xs`}>
                      {deliverable.status.replace('-', ' ')}
                    </Badge>
                  </div>
                  <div className="flex items-center gap-2 text-sm text-muted-foreground">
                    <Calendar className="w-4 h-4" />
                    Target: {deliverable.month}
                  </div>
                </CardContent>
              </Card>
            ))}
        ...
        <div className="mt-16 bg-gradient-hero rounded-2xl p-8 md:p-12 border border-cyber-border">
          <h3 className="text-2xl font-bold mb-8 text-center text-foreground">Project Timeline</h3>
          <div className="grid md:grid-cols-4 gap-6 text-center">
            <div>
              <div className="text-2xl font-bold text-primary mb-2">M1-M8</div>
              <div className="text-sm text-muted-foreground">Phase 1: Analysis & Design</div>
            </div>
            <div>
              <div className="text-2xl font-bold text-accent mb-2">M6-M18</div>
              <div className="text-sm text-muted-foreground">Phase 2: Development</div>
            </div>
            <div>
              <div className="text-2xl font-bold text-primary mb-2">M12-M22</div>
              <div className="text-sm text-muted-foreground">Phase 3: Integration</div>
            </div>
            <div>
              <div className="text-2xl font-bold text-accent mb-2">M18-M24</div>
