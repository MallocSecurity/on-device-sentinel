            ...
            return (
              <Card key={item.id} className="bg-gradient-card border-cyber-border hover:shadow-cyber transition-all duration-300 group">
                ...
                <CardContent>
                  ...
                  >
                    <img
                        src="https://media.licdn.com/dms/image/v2/D4E22AQHm9CL-HNSCxA/feedshare-shrink_2048_1536/B4EZkZI4s3IkA0-/0/1757063385554?e=1772064000&v=beta&t=kzbxsmlmk3hJVwQ2ef_P36mB43RN8ZiYh4-JxXYVOys"                        alt="DAEMON-AI Project Kickoff"
